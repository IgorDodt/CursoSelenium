...
public class TesteCadastro {
	...
	public void deveRealizarCadastroComSucesso(){
		...
		dsl.escrever("elementosForm:sobrenome", "Dodt");
		...
		Assert.assertTrue(dsl.obterTexto("descNome").endsWith("Igor"));
		Assert.assertEquals("Sobrenome: Dodt", dsl.obterTexto("descSobrenome"));
