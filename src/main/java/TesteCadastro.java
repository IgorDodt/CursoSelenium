...
public class TesteCadastro {
	...
	public void deveInteragirComAlertPrompt(){
		...
		driver.findElement(By.id("elementosForm:sobrenome")).sendKeys("Dodt");
		...
		Assert.assertTrue(driver.findElement(By.id("descNome")).getText().endsWith("Igor"));
		Assert.assertEquals("Sobrenome: Dodt", driver.findElement(By.id("descSobrenome")).getText());
